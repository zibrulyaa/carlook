...
$id = $_GET['id'];
global $db;
$query = $db->prepare("SELECT * FROM gearbox WHERE id = $id");
$query->execute();
$gear = $query->fetch(PDO::FETCH_ASSOC);
...
<section class="cars">
    <div class="container">
        ...
        <div class="popup__overlay" id="gear">
            <form class="add__form" action="edit.php" method="post">
                ...
                <label class="popup__inner">
                    <input class="form-input" name="name" type="text" value="<?= $gear['name']?>">
